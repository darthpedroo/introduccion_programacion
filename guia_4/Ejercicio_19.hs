...
esSumaInicialDePrimosAux n i sumaPrimos 
    | n < sumaPrimos = False
    | n == sumaPrimos = True
    | (n > sumaPrimos) && (esPrimo i) = esSumaInicialDePrimosAux n (i+1) (sumaPrimos + (i))
    | (n > sumaPrimos) && not (esPrimo i) = esSumaInicialDePrimosAux n (i+1) sumaPrimos

esSumaInicialDePrimos::Integer->Bool
esSumaInicialDePrimos n = esSumaInicialDePrimosAux n 0 0 